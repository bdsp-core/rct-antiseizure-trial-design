...
y1_log_Without_Remove_Drug= testmat12.f(x_DC,parameters_Without_Drug(1),parameters_Without_Drug(2),parameters_Without_Drug(3));
...
ylabel('min/h','FontSize',14)
%legend('SZ CNN Data ','Curve fit','NaN Val','IIC Gen from Log curve')
legend({'Epileptiform Activity Bruden','Lognormal fit','NaN Val'},'FontSize',14)
% title(sprintf('%s IIC burden and Drug free IIC Burden ', extractBefore(file.name,"_")))
title('Epileptiform Activity Bruden And Lognormal Fit','FontSize',14)
...
ylabel('min/h','FontSize',14)
%legend('SZ CNN Data ','Curve fit','NaN Val','IIC Gen from Log curve')
legend({'Epileptiform Activity Bruden','Sim-fit with PK/PD model','NaN'},'FontSize',14)
%title(sprintf('%s IIC burden and Simulator fit ', extractBefore(file.name,"_")))
title('Epileptiform Activity Bruden include PK/PD model','FontSize',14)
...
ylabel('min/h','FontSize',14)
%legend('SZ CNN Data ','Curve fit','NaN Val','IIC Gen from Log curve')
legend({'Epileptiform Activity Bruden','Drug free Epileptiform Activity Bruden','NaN Val'},'FontSize',14)
% title(sprintf('%s IIC burden and Drug free IIC Burden ', extractBefore(file.name,"_")))
title('Drug free Epileptiform Activity Bruden','FontSize',14)

saveas(fig,sprintf('C:\\Users\\CDAC_01\\Dropbox (Partners HealthCare)\\RCT_sim_paper\\Code\\Code_To_Generate_Figures_Paper\\Figure_1.jpeg'))
