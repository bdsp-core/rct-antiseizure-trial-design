...
for k =1:length(excelfiles )
    ...
    if (k~=12) && (k~=50)
        ...
        plot(x,IIC_final_burden,'LineWidth',1,'Color',cmap(k,:))
        hold on
        ...
        title('Seizure Burden Time Courses')
        
        
    end
end

saveas(fig,'C:\\Users\\CDAC_01\\Dropbox (Partners HealthCare)\\AED_TRIAL_PROJECT\\BadChannelDetetction_demo\\BadChannelDetetction_demo\\SAH\\50 Clients Point of interest\\Testing simulation with out EPS\\Code_Figures_Paper\\Cummulative_Seizure_time_courses.jpeg');
