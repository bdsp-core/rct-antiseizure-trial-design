...
plot(x,y1_log_Drug,'LineWidth',1,'Color',cmap(k,:))
hold on 
...
title('Simulator fit IIC Burdens')

   
 
end

saveas(fig,'C:\\Users\\CDAC_01\\Dropbox (Partners HealthCare)\\AED_TRIAL_PROJECT\\BadChannelDetetction_demo\\BadChannelDetetction_demo\\SAH\\50 Clients Point of interest\\Testing simulation with out EPS\\Code_Figures_Paper\\Cummulative_Sim_Fit_Y_limit.jpeg');
